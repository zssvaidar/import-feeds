...
class V1Dot2Dot0 extends V1Dot0Dot13
{
    public function up(): void
    {
        ...
        $this->execute("ALTER TABLE `import_configurator_item` ADD `column` VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci");
        $this->execute("ALTER TABLE `import_configurator_item` ADD `default` VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci");
    }
